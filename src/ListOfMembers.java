...
public class ListOfMembers extends javax.swing.JFrame {
    ...
    public ListOfMembers() {
        ...
        try {
            ...
            while(rs.next()){
                model.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(7),rs.getString(11),rs.getString(12),rs.getString(9)});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Member ID", "Name", "Mobile", "NIC", "Gender", "Address", "Guard.Name", "Guard.Mobile", "Gym Time"
            }
        ) {
